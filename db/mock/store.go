...
// Source: github.com/JaidenShall/simplebank/db/sqlc (interfaces: Store)
...
func (m *MockStore) WithdrawTx(arg0 context.Context, arg1 db.WithdrawTxParams) (db.WithdrawTxResult, error) {
	m.ctrl.T.Helper()
